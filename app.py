...
def main():
    ...
    st.write("1. Upload your Form 16 or any other document regarding you investment in PDF and PPTX files using the file uploader.")
    ...
    with st.sidebar:
        ...
        uploaded_files = st.file_uploader("Upload your TAX DOCUMENT PDF or PPTX Files and Click on the Submit & Process Button", accept_multiple_files=True, type=["pdf", "pptx"])
    ...
    st.write("Created with ❤️ by CODE RANGERS")
